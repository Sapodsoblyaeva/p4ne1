...
r = s.post("https://10.31.70.210:55443/api/v1/auth/token-services",auth=("restapi", "j0sg1280-7@"), verify=False)

token = r.json()['token-id']
header = {"content-type": "application/json", "X-Auth-Token": token}
r = s.get("https://10.31.70.210:55443/api/v1/interfaces", headers=header, verify=False)
print(r.status_code)
